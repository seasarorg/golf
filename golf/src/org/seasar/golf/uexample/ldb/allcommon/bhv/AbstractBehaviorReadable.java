...
public abstract class AbstractBehaviorReadable implements BehaviorReadable {
     ...
     * @exception org.seasar.golf.uexample.ldb.allcommon.exception.RecordHasAlreadyBeenDeletedException
     */
    protected void assertRecordHasNotBeenDeleted(org.seasar.golf.uexample.ldb.allcommon.Entity entity, Object searchKey4log) {
        if (entity == null) {
            String msg = "The record has already been deleted by other thread: searchKey=" + searchKey4log;
            throw new org.seasar.golf.uexample.ldb.allcommon.exception.RecordHasAlreadyBeenDeletedException(msg);
        }
    }
    ...
    protected void assertRecordHasBeenSelectedAsOne(java.util.List ls, Object searchKey4log) {
        ...
        if (ls.size() != 1) {
            ...
            throw new org.seasar.golf.uexample.ldb.allcommon.exception.RecordHasOverlappedException(msg);
        }
    }
     ...
     * @exception org.seasar.golf.uexample.ldb.allcommon.exception.SelectedCountExceedMaxCountException
     */
    protected void assertSelectedCountHasNotExceededMaxCount(int selectedCount, int maxCount, String clauseString) {
        if (selectedCount > maxCount) {
            ...
            throw new org.seasar.golf.uexample.ldb.allcommon.exception.SelectedCountExceedMaxCountException(msg, selectedCount, maxCount);
        }
    }
     ...
     * @param cb Condition-bean. (NotNull)
     */
    protected void assertConditionBeanNotNull(org.seasar.golf.uexample.ldb.allcommon.cbean.ConditionBean cb) {
