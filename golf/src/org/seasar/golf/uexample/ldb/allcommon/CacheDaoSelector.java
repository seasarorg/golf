...
import org.seasar.golf.uexample.ldb.allcommon.bhv.BehaviorReadable;
import org.seasar.golf.uexample.ldb.allcommon.bhv.BehaviorWritable;
...
public class CacheDaoSelector implements DaoSelector {
    ...
    protected void setupDaoCacheMap() {
        if (_daoCacheMap == null) {
            ...
            _daoCacheMap.put(org.seasar.golf.uexample.ldb.exdao.VendorDao.class, getVendorDao());

        }
    }

    protected org.seasar.golf.uexample.ldb.exdao.VendorDao _vendorDao;
    public void setVendorDao(org.seasar.golf.uexample.ldb.exdao.VendorDao dao) {
        _vendorDao = dao;
    }
    public org.seasar.golf.uexample.ldb.exdao.VendorDao getVendorDao() {
        return _vendorDao;
    }
    ...
    protected void setupBhvCacheMap() {
        if (_bhvCacheMap == null) {
            ...
            _bhvCacheMap.put(org.seasar.golf.uexample.ldb.exbhv.VendorBhv.class, getVendorBhv());
    ...
    protected void setupDaoBhvMap() {
        if (_daoBhvMap == null) {
            ...
            _daoBhvMap.put(org.seasar.golf.uexample.ldb.exdao.VendorDao.class, org.seasar.golf.uexample.ldb.exbhv.VendorBhv.class);
  
        }
    }
  
    protected org.seasar.golf.uexample.ldb.exbhv.VendorBhv _vendorBhv;
    public void setVendorBhv(org.seasar.golf.uexample.ldb.exbhv.VendorBhv bhv) {
        _vendorBhv = bhv;
    }
    public org.seasar.golf.uexample.ldb.exbhv.VendorBhv getVendorBhv() {
        return _vendorBhv;
    }
